...
//   Dummy product data
  const products = [
    ...
    { id: 3, name: "Comfort Handy Craft", price: "$42.00", oldPrice: "$65.00", img: "/latest3.png", isSale: false },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => (
            <div key={product.id} className="border rounded-md shadow-md p-4 bg-white relative group">
              ...
              <Image src={product.img} width={270} height={361} className="h-32 w-32 bg-no-repeat" alt="chair"></Image>
                {product.isSale && (
