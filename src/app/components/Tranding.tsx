...
const TrendingProducts: React.FC = () => {
  const products = [
    ...
    { id: 4, name: "Cantilever Chair", price: "$26.00", oldPrice: "$42.00", image: "/c4.png" },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-10">
          {products.map((product) => (
            <div key={product.id} className="border rounded-lg p-2 shadow-lg text-center">
              <Image src={product.image} width={270} height={100} alt="product.name" className="w-full  h-60 object-cover mb-4" ></Image>
